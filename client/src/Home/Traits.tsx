...
const Header: React.FC = () => (
  <AppBar position="static" color="primary">
    <Toolbar>
      <Typography variant="h4" component="div" sx={{ paddingTop: 2, paddingBottom:2, flexGrow: 1, textAlign: 'center'}}>
        TOXIC TRAITS
      </Typography>
    </Toolbar>
  </AppBar>
...
const traits = [
  ...
  [
    ...
    'Has a mullet so everyone knows hes from the south',
  ...
  /* Aditi */ [
    ...
    'Is chronically late for everything', 
    'Cannot drink coffee'
  ],
...
const TraitsCards: React.FC = () => {
  ...
  return(
  <Grid container columnSpacing={4} rowSpacing={4}  justifyContent="center" sx={{ paddingTop: 10, paddingBottom: 10, paddingLeft: 5, paddingRight: 5}}  >
    {names.map((name, index) => (
      <Grid item xs={12} sm={3} key={index}>
        {' '}
        {/* xs=12 for mobile, sm=6 for 2 columns */}
        <Card variant="outlined" sx={{borderRadius: '16px', maxwidth: 400, objectFit: "contain", border: '3px solid #FAFAFA'}}>
